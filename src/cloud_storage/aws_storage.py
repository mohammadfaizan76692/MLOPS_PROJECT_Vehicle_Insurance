...
class SimpleStorageService:
    """
    A class for intracting with AWS S3 storage, providing methods for file managements,
    data upload, and data retrieval in s3 buckets
    """

    def __init__(self):
        """
        Initilizes the SimpleStorageService instance with S3 resource and client from the  S3Client class.
    ...
    def get_bucket(self, bucket_name:str)-> Bucket:
        ...
        Returns:
            Bucket: S3 bucket objects
        """
        logging.info("Entered the get_bucket method of SimpleStorageService class")
        try:
            bucket = self.s3_resource.Bucket(bucket_name)
            logging.info("Exited the get_bucket method of SimpleStorageService clss")
            return bucket
    ...
    def s3_key_path_available(self, bucket_name, s3_key)-> bool:
        ...
        Args:
            ...
            s3_key(str): key path of the fie to check
        Returns:
            bool: True
        """
        try:
    ...
    def get_file_object(self, filename:str, bucket_name:str) -> Union[List[object],object]:
        """
        Retrieves the file objects from the specified bucket based on the filename.

        Args:
            filename (str): The name of the file to retrieve.
            bucket_name (str): The name of S3 bucket.
    ...
    def load_model(self, model_name:str, bucket_name:str, model_dir:str = None)-> object:
        ...
        Args:
            model_name (str): Name of the model in the bucket
            bucket_name (str): Name of the S3 bucket
    ...
    def upload_file(self, from_filename: str, to_filename:str, bucket_name:str, remove:bool = True):
        ...
        """
        logging.info("Entered the uplodad_file in method of SimpleStorageService class")

        try:
            logging.info("Uploading {from_file} to {to_filename} in {bucket_name}")
            ...
            logging.info("Exited the uplaod_file method of SimpleStorageService class")
