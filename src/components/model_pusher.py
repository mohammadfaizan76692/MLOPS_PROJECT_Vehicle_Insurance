...
class ModelPusher:
    ...
    def __init__(self, model_evaluation_artifact:ModelEvaluationArtifact,
        ...
        """
        :param model_evaluation_artifact: Output refrence of Data evaluation artifact stage
    ...
    def initiate_model_pusher(self)-> ModelPusherArtifact:
        ...
        try:
            ...
            self.proj1_estimator.save_model(from_file = self.model_evaluation_artifact.trainer_model_path)
