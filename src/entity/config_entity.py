...
TIMESTAMP: str = datetime.now().strftime("%m_%_d_%Y_%H_%M_%S")

@dataclass
class TrainingPipelinceConfig:
    pipeline_name : str = PIPELINE_NAME
    artifact_dir : str= os.path.join(ARTIFACT_DIR,TIMESTAMP)
    timestamp : str= TIMESTAMP

training_pipeline_config: TrainingPipelinceConfig = TrainingPipelinceConfig()
